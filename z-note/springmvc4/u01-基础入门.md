...
**概念：** 动作方法形参中可直接使用Servlet原生对象存值，除此外：
...
- psm: `{{tomcat}}/springmvc4/api/scope/servlet`
- psm: `{{tomcat}}/springmvc4/api/scope/request-scope`
- psm: `{{tomcat}}/springmvc4/api/scope/session-scope`

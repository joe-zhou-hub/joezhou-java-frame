...
- tst: `c.j.ioc.StartTest.buildByConstructor()`
- tst: `c.j.ioc.StartTest.buildByStaticFactory()`
- tst: `c.j.ioc.StartTest.buildByDynamicFactory()`
...
**概念：** `<bean>` 的 `init-method/destroy-method` 属性可以分别指定该bean的初始化方法和销毁方法。

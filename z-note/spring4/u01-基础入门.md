...
- src: `c.j.pojo.Student`
- tst: `c.j.start.StartTest.loadMultipleXmlByArray()`
- tst: `c.j.start.StartTest.loadMultipleXmlByImport()`
...
- src: `c.j.pojo.Student`
- tst: `c.j.start.StartTest.getBeanById()`
- tst: `c.j.start.StartTest.getBeanByName()`
- tst: `c.j.start.StartTest.getBeanByClass()`
...
**源码：** /spring4/
- res: `classpath:spring/start/lazy.xml`
- src: `c.j.pojo.User`

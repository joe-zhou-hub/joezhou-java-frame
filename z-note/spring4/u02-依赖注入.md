...
**概念：** 使用Java代替xml配置容器并实现SpringIOC是Spring4.x推荐的配置方式，是通过三个注解实现的：
...
- 配置类：com.joezhou.config.SpringConfig

## 1. spring测试

**概念：** 
- 本案例使用spring提供的与junit整合的一套测试方案，使用前提是要添加spring整合junit的依赖包。 
- `spring-test` 需要junit4.12版本或以上。
